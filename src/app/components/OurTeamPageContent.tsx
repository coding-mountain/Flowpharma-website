...
const teamData = {
  board: [
    ...
    {
      name: "John Brady",
      role: "B.A. (Dartmouth), MBA (UCLA)",
      image: IMAGES.ourTeams.team18,
      description:
        "As the Founder and Managing Partner of CUP Capital Management, John is a diversified global investor with an emphasis on technology and asymmetric upside opportunities in a “New World” defined by the accelerating speed of change and persistent volatility.  As the Portfolio Manager and Global Head of Real Estate at Oaktree Capital Management for almost 20 years, John led the deployment of over $70 billion in total capitalization mostly focused on “seed planting” and “platform building” through distressed cycles into growth cycles. John's most notable achievement at Oaktree was leading the Public Private Partnership Program with the U.S. Treasury through the GFC, as one of eight institutional managers among 100 plus applicants. With none of the $10 billion in AUM required for selection, John's team was still selected and proceeded to generate the highest IRR for U.S. taxpayers (26%) in buying mortgage-backed securities to reliquefy global capital markets.  Today, John's current focus is spread across ten or so investment platforms, including: Polar Blue, emissions-free energy at a cost less than fossil fuels; Metal Logic, emissions-free steel at a cost less than fossil fuels; various distressed real estate operating businesses; and Flo Pharma in which he provided the “bridge” capital to maintain momentum through the recent bio-tech decline.  John typically serves in Co-Chair, Board, and/or Strategic Advisory roles, including Global Humanitarian Ambassador for Polar Blue and Metal Logic. In early-2025, he led the restructuring of Maxwell Technologies (ultracapacitor company acquired from Tesla in 2021) which was sold to Clarios International later in 2025 for over 5X the post-restructuring valuation—CUP's first liquidity event.",
    },
  ],
  management: [
    {
      name: "Daniel Felton",
      role: "President",
      image: IMAGES.ourTeams.danial,
      description:
        "Daniel Felton, MD,is an executive leader and operator with a track record of translating strategy into measurable results in healthcare-focused organizations. With a background as a family medicine physician, he applies a diagnostic, systems-oriented approach to leadership: identifying high-impact opportunities, aligning decision making, and executing plans with discipline to achieve priorities. Most recently, Dr. Felton led the transformation of a medical billing company into a full-service healthcare practice management organization, coordinating strategy, reallocating capital, and optimizing operations to support sustained growth. As President of Flo Pharma, Dr. Felton is focused on advancing the company's vaccine and immunotherapy platform into clinical development. He uses strategy, capital prioritization, and cross-functional execution to increase enterprise value and scale the business as it brings scientific innovation into life-changing patient impact.",
    },
    {
      name: "Dylan Bruno",
    ...
    },
    {
      ...
      description:
        'Rick Graf is a high-reps venture/PE dealmaker—an experienced counsel who has led 150+ venture transactions totaling $1.5B+, and has advised startups across software, payments, biotech, and remote healthcare companies from founding through IPO-stage realities. He blends big-firm transaction rigor with founder empathy (he\'s been a co-founder/GC himself), which makes him a pragmatic guide on financing, governance, and "how to get it done without stepping on landmines." He brings discipline, risk-mitigation, and crisp decision framing—keeping a fast tempo.',
    },
    {
      name: "Asif Nazeer",
      ...
      description:
        'Asif Nazeer is a finance and controls professional who brings real backbone to governance: a Director of Finance profile focused on strategy, performance oversight, and building transparent structures that keep organizations resilient and future-ready. He has 20+ years experience across telecom, IT, financial services, and fintech, grounded in audit/corporate finance—and credentials that include FCCA/FCA with prior experience at PwC. He\'s the person who makes sure the numbers are clean, the controls are appropriate, and the operating rhythm is predictable—while still thinking like a growth partner, not a "department of no."',
    },
    {
      name: "CDRE (ret) Moshabab Alqahtani",
      role: "Regional Advisor",
      image: IMAGES.ourTeams.teamMoshab,
      description:
        "Retired Commodore Moshabab Alqahtani, a distinguished and highly decorated naval officer, served in the Saudi Arabian Navy and the Ministry of Interior with unparalleled dedication and valor for over 33 years.Alqahtani demonstrated exceptional leadership and strategic thinking throughout his training and education. He excelled and obtained his Bachelor of Military Marine Science from King Fahad Naval College and his Masters in Military Science from the Saudi Arabian Armed Forces Command and Staff College. He embarked on a distinguished career marked by a series of commendations and advancements. His commitment to excellence and unwavering sense of duty earned him recognition for his abilities.During his tenure, CDRE (ret) Alqahtani played pivotal leadership roles in various exercises, including North Thunder and others. His oversight and management were instrumental in ensuring the effectiveness and efficiency of these exercises, contributing significantly to their success. Commodore Alqahtani's commitment to professional development was evident in his continuous pursuit of advanced training and education both domestically and abroad, including opportunities in the United States and France. He further honed his skills in global diplomacy and leadership through these experiences. In recognition of his service, Commodore Alqahtani was awarded the Centennial Medal, Desert Storm Medal, and the Meritorious Service Medal, among others, for his contributions to regional stability and cooperation. Upon retirement, Commodore Alqahtani continues to contribute to promoting peace, security, and prosperity for his country through various advisory roles and activities.",
    },
  ],
  advisory: [
    {
  ...
  return (
    <div className="min-h-screen bg-white font-sans w-full -mb-12">
      <div className="w-full px-6 py-8 md:px-12 md:py-12">
        ...
        {/* Header Section */}
        <div className="w-full mb-16" id="strong-leadership">
        ...
        <div className="mb-16 w-full">
          <h2 className="text-2xl font-medium text-gray-900 mb-8 pb-4 border-b border-gray-200">
            Board of Directors
          </h2>
