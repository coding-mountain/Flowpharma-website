            ...
            <div className="mb-16 w-full">
                ...
                <div className="flex justify-center mt-10">
                    <button
                        ...
                        className={`flex justify-between items-center cursor-pointer gap-4 border-2 border-[#0A253A] rounded-xl px-12 py-3 font-normal text-xl ${isScrolled ? 'hover:text-white hover:opacity-80' : 'hover:text-gray-500 hover:opacity-80'
                            } `}>

                        <p className="text-[#0A253A]">
                            View All
                        </p>
                        <img src={IMAGES.homepage.viewAllIcon} alt="blank" className="h-3.5" />
                    </button>
                </div>
